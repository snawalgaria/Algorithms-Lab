...
public class probA {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 1; t <= cases; t++) {
            ...
            Point2D a = new Point2D.Double(Double.parseDouble(line[0]),Double.parseDouble(line[1]));

            line = br.readLine().split(" ");
            Point2D b = new Point2D.Double(Double.parseDouble(line[0]),Double.parseDouble(line[1]));

            line = br.readLine().split(" ");
            Point2D c = new Point2D.Double(Double.parseDouble(line[0]),Double.parseDouble(line[1]));


            StringBuilder out = new StringBuilder();
            out.append("Case #").append(t).append(": \n");

            Point2D orthocenter = getOrthoCenter(a,b,c);
            
            Point2D centroid = getCentroid(a,b,c);
            
            Point2D circumcenter = getCircumCenter(a,b,c);

            out.append(centroid.getX()).append(" ").append(centroid.getY()).append("\n");
           
            out.append(orthocenter.getX()).append(" ").append(orthocenter.getY()).append("\n");
           
            out.append(circumcenter.getX()).append(" ").append(circumcenter.getY());
    ...
    static Point2D getCircumCenter(Point2D a, Point2D b, Point2D c){
    ...
    static Point2D getBisector(Point2D a, Point2D b, Point2D c){
    ...
    static Point2D getOrthoCenter(Point2D a, Point2D b, Point2D c){
        ...
        p2= new Line2D.Double(a, getBisector(b,c,a));
        p1 = new Line2D.Double(c,getBisector(a,b,c));
