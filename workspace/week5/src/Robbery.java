...
class Robbery
{
	...
	public static void main (String[] args) throws java.lang.Exception
	{
		...
		for(int i=1;i<=noOfCases;i++)
		{
			...
			int policemen=Integer.valueOf(input[0]);
			int intersections=Integer.valueOf(input[1]);
			int roads=Integer.valueOf(input[2]);
		...
		Robbery m = new Robbery(intersections);
		
		
			int output=m.fordFulkerson(adjMat, 0, intersections-1);
			if(output>policemen)
			{
